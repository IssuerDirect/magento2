...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $eceEnabled = $this->expressCheckoutConfig->isEnabled('checkout_page');
        ...
        $data = [
            'payment' => [
                ...
                'express_checkout' => [
                    'enabled' => $eceEnabled,
                    'initParams' => $eceEnabled ? $this->serializer->unserialize($this->initParams->getWalletParams()) : [],
                    'buttonConfig' => $eceEnabled ? $this->expressCheckoutConfig->getButtonOptions() : []
                ],
